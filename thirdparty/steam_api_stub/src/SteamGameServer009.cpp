...
bool CSteamGameServer009::BLoggedOn() {
...
bool CSteamGameServer009::BSecure() {
...
bool CSteamGameServer009::BUpdateUserData( CSteamID steamIDUser, const char *pchPlayerName, uint32 uScore ) {
...
bool CSteamGameServer009::BSetServerType( uint32 unServerFlags, uint32 unGameIP, uint16 unGamePort, uint16 unSpectatorPort, uint16 usQueryPort, const char *pchGameDir, const char *pchVersion, bool bLANMode ) {
...
bool CSteamGameServer009::BGetUserAchievementStatus( CSteamID steamID, const char *pchAchievementName ) {
