...
public:
	...
	SteamAPICall_t CheckFileSignature(const char *);
	bool ShowGamepadTextInput(EGamepadTextInputMode,EGamepadTextInputLineMode,const char *,uint32);
	uint32 GetEnteredGamepadTextLength();
	bool GetEnteredGamepadTextInput(char *,uint32);
};
