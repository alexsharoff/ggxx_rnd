...
struct _match_state_2
{
    ...
    */
    ...
    // test/replays/matches/session10.ggr (frame 0x2e0, synctest 1f)
    // at :base+C1B62
...
typedef uint32_t (reset_directx_device_func_t)();
...
struct gg_globals
{
    ...
    reset_directx_device_func_t* reset_directx_device = nullptr;
